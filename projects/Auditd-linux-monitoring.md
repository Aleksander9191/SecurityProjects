...
| Category | Value |
|----------|-------|
| **MITRE ATT&CK** | T1098 – Account Manipulation *(Potential Detection)* |
| **Monitored Object** | `/etc/passwd` |
...
| ---------------- | ---------------------------------------------------- |
| MITRE ATT&CK     | T1098 – Account Manipulation *(Potential Detection)* |
| Monitored Object | `/etc/shadow`                                        |
| Audit Key        | `shadow_changes`                                     |
| Log Source       | Linux auditd                                         |
| Destination      | Elastic Stack                                        |
## Audit Rule
...
| Category | Value |
|----------|-------|
| **MITRE ATT&CK** | **T1548 – Abuse Elevation Control Mechanism** *(Potential Detection)* |
| **Monitored Object** | `/etc/sudoers` |
| **Audit Key** | `sudoers_changes` |
| **Log Source** | Linux auditd |
| **Destination** | Elastic Stack |
...
| **Monitored Object** | `/usr/bin/sudo` |
| **Audit Key** | `sudo_execution` |
| **Log Source** | Linux auditd |
| **Destination** | Elastic Stack |
